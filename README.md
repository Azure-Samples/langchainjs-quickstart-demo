...
- The [local prototype](src/prototype.js), using FAISS and Ollama with the Llama2 model
- The [Azure cloud version](src/azure.js), using Azure AI Search and GPT-4 Turbo
